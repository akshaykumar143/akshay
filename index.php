 ...
 <head>
     ...
     <link href="./assets/style/mstyle.css" rel="stylesheet">
                 ...
                 <div class="app-main__inner"> -->
                     ...
                     <div>
                         <div class="row">
                             <div class="col-lg-6">
                                 <div class="main-card mb-3 card">
                                     <div class="card-body">
                                         ...
                                         <h3><span class="count-up-wrapper">$898</span></h3>
                                     </div>
                                 </div>
                             </div>
                             <div class="col-lg-6">
                                 <div class="main-card mb-3 card">
                                     <div class="card-body">
                                         ...
                                         <div class="text-center">
                                             <h3>
                                                 <span class="count-up-wrapper-4">898 </span>
                                             </h3>
                                         </div>
                                     </div>
                                 </div>
                             ...
                             <div class="col-sm-12">
                                 <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                                     <thead>
                                         <tr role="row">
                                             <th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 200.95px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Name</th>
                                             <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 313.95px;" aria-label="Position: activate to sort column ascending">Position</th>
                                             <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 152.95px;" aria-label="Office: activate to sort column ascending">Office</th>
                                             <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 77.95px;" aria-label="Age: activate to sort column ascending">Age</th>
                                             <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 145.95px;" aria-label="Start date: activate to sort column ascending">Start date</th>
                                             <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 117.2px;" aria-label="Salary: activate to sort column ascending">Salary</th>
                                         </tr>
                                     </thead>
                                     <tbody>
                         ...
                         <div class="row">
                             <div class="col-md-4">
                                 <div class="card mb-3 widget-chart">
                                     ...
                                     <div class="widget-numbers"><span class="count-up-wrapper-2">61k</span></div>
                                     <div class="widget-subheading">Total Views</div>
                                     <div class="widget-description text-success">
                                         <i class="fa fa-angle-up"></i>
                                         <span class="pl-1">
                                             <span class="count-up-wrapper-3">88 %</span>
                                         </span>
                                     </div>
                                 </div>
                             </div>
                             ...
                             <div class="col-md-4">
                                 <div class="card mb-3 widget-chart">
                                     ...
                                     <div class="widget-description text-primary">
                                         <span class="pr-1 count-up-wrapper-3">88 %</span>
                                         <i class="fa fa-angle-up"></i>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="row">
                             ...
                             <!-- akshay https://demo.dashboardpack.com/architectui-html-pro/charts-sparklines.html -->
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-6">
                                             <div class="input-group">
                                                 ...
                                                 <input class="form-control input-mask-trigger" data-inputmask="'alias': 'decimal', 'groupSeparator': ',', 'autoGroup': true" im-insert="true" style="text-align: right;">
                                             </div>
                                             <small class="form-text text-muted">
